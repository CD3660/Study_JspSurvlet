			...
			<div class="container px-5 my-5">
				...
				<div class="row gx-5 justify-content-center">
					<div class="col-lg-11 col-xl-9 col-xxl-8">
									...
									<div class="row align-items-center gx-5">
										<div class="col text-center text-lg-start mb-4 mb-lg-0">
											<div class="bg-light p-4 rounded-4">
												...
												<div class="small fw-bolder">파리 생제르맹</div>
												<div class="small text-muted">No.30</div>
												<div class="small text-muted">Paris, France</div>
											</div>
										</div>
										<div class="col-lg-8">
											<div>발롱도르는 FC 바르셀로나 팀 동료였고 절친한 친구인 루이스 수아레스가 직접 수여해
												주었다. 수상 직후 메시가 시상식장에 준비되어 있던 버튼을 누르자, 파리의 에펠탑이 밝게 빛나며 메시의
												얼굴이 샤요궁에 비추어지는 명예를 얻었다. 또한 메시는 이번 수상까지 포함하여 각각 2000년대,
												2010년대, 2020년대에 발롱도르를 수상하며 축구 역사에 전무후무할 만한 기록을 세우게 되었고, 파리
												생제르맹 FC 소속 선수로서 최초의 발롱도르 수상자가 되었다.</div>
										</div>
									</div>
								</div>
							</div>
						...
						<!-- Education Section-->
						<section>
							<h2 class="text-secondary fw-bolder mb-4">아르헨티나 국가대표</h2>
							<!-- Education Card 1-->
							<div class="card shadow border-0 rounded-4 mb-5">
								<div class="card-body p-5">
									<div class="row align-items-center gx-5">
										<div class="col text-center text-lg-start mb-4 mb-lg-0">
											<div class="bg-light p-4 rounded-4">
												<div class="text-secondary fw-bolder mb-2">2005 - 2006</div>
												<div class="mb-2">
													<div class="small fw-bolder">아르헨티나 유스</div>
												</div>
											</div>
										</div>
										<div class="col-lg-8">
											<div>국가대표로서 메시의 시작을 알린 대회. FC 바르셀로나 팬들 사이에선 이미 역대급
												유망주라는 평가를 받고 있던 메시가 본격적으로 전세계 최고의 유망주로 인정받은 대회이기도 하다. 마라도나가
												유스 챔피언십을 우승했던 것처럼 메시 또한 결승전에서 나이지리아를 2:1로 잡고 우승하였다. 골든볼, 골든슈
												또한 수상했다. 골든볼을 수상할 당시 메시의 나이는 18세 8일로 마라도나 이후 최초의 18세 수상자이면서
												역대 최연소 골든볼 수상자였는데 이 기록은 현재까지도 유지되고 있다. 최종 성적: 7경기 6골 2도움,
												골든볼, 골든슈</div>
										</div>
									</div>
								</div>
							...
							<div class="card shadow border-0 rounded-4 mb-5">
								<div class="card-body p-5">
									<div class="row align-items-center gx-5">
										<div class="col text-center text-lg-start mb-4 mb-lg-0">
											<div class="bg-light p-4 rounded-4">
												<div class="text-secondary fw-bolder mb-2">2006 - 2023</div>
												<div class="mb-2">
													<div class="small fw-bolder">아르헨티나 A대표팀</div>
												</div>
											</div>
										</div>
										<div class="col-lg-8">
											<div>남아메리카 역대 최다 출장, 최다 득점자이자 월드컵 최다 출전, 월드컵 최다 공격포인트,
												코파 아메리카 최다 공격포인트, 국가대표 메이저 대회 최다 MVP에 선정됐으며 아르헨티나에 28년 만의 코파
												아메리카 우승과 36년 만의 월드컵 우승을 안긴, 디에고 마라도나, 펠레와 함께 축구 국가대표 역사상 최고의
												선수이다. 월드컵 역사상 유일무이한 골든볼 2회 수상과 코파 아메리카 MVP 2회 수상으로 총 국가대표
												메이저 대회(FIFA 월드컵과 대륙컵) MVP 4회의 대기록을 보유하고 있다. 이 외에도, 코파 아메리카
												득점왕 1회와 도움왕 4회, 월드컵 실버부츠, 월드컵 도움왕 2회, 월드컵 베스트 11과 코파 아메리카
												베스트 11 4회 선정 등의 실로 끝판왕 급의 국가대표 개인수상 커리어를 보유하고 있다. 메이저 대회
												토너먼트로 봐도 역시 역대 최다 공격 포인트 보유자.</div>
										</div>
									</div>
								</div>
							</div>
