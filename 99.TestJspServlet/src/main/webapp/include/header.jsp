		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1 select"><a id="select"
						class="nav-link py-3 px-0 px-lg-3 rounded select" href="list">조회</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a id="insert"
